...
var contextPath = "/ispw/{srid}/releases/{releaseId}/tasks/build?level={level}&mname={mname}&mtype={mtype}&assignmentId={assignmentId}";
...
class BuildReleaseAction extends IspwActions {
    performAction(input) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let json = yield cmnService.doPostRequest(url, reqTO.reqBody, input.cesToken, "Build Release", input.showResponseBodyInConsole);
